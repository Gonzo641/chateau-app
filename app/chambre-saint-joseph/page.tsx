    ...
    return (
      <div className="mt-[123px]">
        <div className="w-full h-[36rem] flex justify-center items-center">
          ...
          CHAMBRE D’HÔTES<br/> « SAINT-JOSEPH »
          </h2>
          <img src="/image/ChambreSaintJoseph/SaintJoseph1.jpg" 
               alt="image" 
        ...
        <div className="flex flex-col 2xl:flex-row px-4 xl:px-64 gap-8 mb-8 xl:mb-0">
          <div className="w-full 2xl:w-[136rem] h-[26rem] xl:h-[45rem] mt-28 xl:mt-0">
            <img src="/image/ChambreSaintJoseph/SaintJoseph2.jpg" 
                alt="image" 
          ...
          <div className="flex flex-col xl:p-20 gap-4">
            <h4 className="font-bold text-xl">
              BIENVENUE DANS LA CHAMBRE SAINT-JOSEPH
            </h4>
            <p>
              Certains la surnomment « la romantique »… Son papier peint délicatement 
              fleuri est un héritage des décennies passées. Sa cheminée en marbre et son 
              authentique parquet aux lames irrégulières datent de la construction du 
              château. Une salle de douche privée complète cette chambre de charme.
              <br/><br/>
              Depuis le lit niché dans son alcôve, la vue est imprenable sur le jardin à la française.
              Aux beaux jours, profitez de la piscine pour un pur moment de détente.
              <br/><br/>
              Tarif de la chambre : 210 euros, petit déjeuner compris<br/>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 xl:gap-2 px-4 xl:px-40">
          ...
          <img src="/image/ChambreSaintJoseph/SaintJoseph7.jpg" alt="image" className="w-full h-64 xl:h-80 rounded-xl object-cover" />
          <img src="/image/ChambreSaintJoseph/SaintJoseph6.jpg" alt="image" className="w-full h-64 xl:h-80 rounded-xl object-cover" />
        </div>

        <div>
          <img src="/image/ChambreSaintJoseph/SaintJoseph3.jpg" alt="image" className="w-full h-40 xl:h-80 mt-12 object-cover" />
        </div>
        <ContactButton />
      </div>
    )
